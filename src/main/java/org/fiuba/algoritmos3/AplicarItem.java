...
public class AplicarItem implements Opciones{
    ...
    public void aplicarOpcion(Jugador jugador, Jugador jugadorAdversario){
        ...
        if(Objects.equals(itemAplicable.getTipo(), "Estadistica")){
            decidirAplicarItem(jugador, jugador.getNombrePokemonActual(), itemAplicable);
        }else {
            ...
            decidirAplicarItem(jugador, nombrePokemon, itemAplicable);
        }
