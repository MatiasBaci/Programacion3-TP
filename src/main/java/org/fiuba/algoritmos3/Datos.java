...
public class Datos {
    ...
    private void InicialzarPokemonesJugador1(){
        ...
        119, 63, 85, 70);
        Habilidad chorroDeAgua = new HabilidadAtaque("ChorroDeAgua",Tipo.obtenerUnTipo("Agua"),40,25);
        squirtle.añadirHabilidad(chorroDeAgua);
        Habilidad cabezazo = new HabilidadAtaque("Cabezazo",Tipo.obtenerUnTipo("Normal"),130,10);
        ...
        153, 120, 105, 129);
        Habilidad tajoAereo = new HabilidadAtaque("TajoAereo",Tipo.obtenerUnTipo("Volador"),75,15);
        charizard.añadirHabilidad(tajoAereo);
        Habilidad lanzallamas = new HabilidadAtaque("Lanzallamas",Tipo.obtenerUnTipo("Fuego"),90,15);
        charizard.añadirHabilidad(lanzallamas);
        Habilidad garraDragon = new HabilidadAtaque("GarraDragon",Tipo.obtenerUnTipo("Dragon"),80,15);
        ...
        110, 110, 70, 75);
        Habilidad trueno = new HabilidadAtaque("Trueno",Tipo.obtenerUnTipo("Electrico"),110,10);
        ...
        Habilidad colaFerrea = new HabilidadAtaque("ColaFerrea",Tipo.obtenerUnTipo("Normal"),100,15);
        ...
        100, 110, 90, 135);
        Habilidad esferaAural = new HabilidadAtaque("EsferaAural",Tipo.obtenerUnTipo("Lucha"),80,20);
        lucario.añadirHabilidad(esferaAural);
        Habilidad pulsoNoche = new HabilidadAtaque("PulsoNoche",Tipo.obtenerUnTipo("Normal"),80,15);
        ...
        Habilidad metalaser = new HabilidadAtaque("Metalaser",Tipo.obtenerUnTipo("Normal"),140,5);
        ...
        120, 65, 155	, 120);
        Habilidad bolaSombra = new HabilidadAtaque("BolaSombra",Tipo.obtenerUnTipo("Fantasma"),80,15);
        ...
        Habilidad pulsoUmbrio = new HabilidadAtaque("PulsoUmbrio",Tipo.obtenerUnTipo("Normal"),80,15);
        dusknoir.añadirHabilidad(pulsoUmbrio);
        Habilidad terratemblor = new HabilidadAtaque("Terratemblor",Tipo.obtenerUnTipo("Tierra"),60,20);
        ...
        160, 150, 100, 110);
        Habilidad venenoX = new HabilidadAtaque("VenenoX",Tipo.obtenerUnTipo("Veneno"),70,20);
        crobat.añadirHabilidad(venenoX);
        Habilidad tijeraX = new HabilidadAtaque("TijeraX",Tipo.obtenerUnTipo("Bicho"),80,15);
        crobat.añadirHabilidad(tijeraX);
        Habilidad acrobata = new HabilidadAtaque("Acrobata",Tipo.obtenerUnTipo("Volador"),110,15);
    ...
    private void InicialzarPokemonesJugador2(){
        ...
        100	, 140, 65, 155);
        Habilidad psiquico = new HabilidadAtaque("Psiquico",Tipo.obtenerUnTipo("Psiquico"),90,10);
        ...
        Habilidad energibola = new HabilidadAtaque("Energibola",Tipo.obtenerUnTipo("Planta"),90,10);
        ...
        100, 76, 102, 130);
        Habilidad mazazo = new HabilidadAtaque("Mazazo",Tipo.obtenerUnTipo("Planta"),120,15);
        trevenant.añadirHabilidad(mazazo);
        Habilidad sombraVil = new HabilidadAtaque("SombraVil",Tipo.obtenerUnTipo("Fantasma"),80,15);
        ...
        100, 65, 150, 140);
        Habilidad terremoto = new HabilidadAtaque("Terremoto",Tipo.obtenerUnTipo("Tierra"),100,10);
        golem.añadirHabilidad(terremoto);
        Habilidad rocaAfilada = new HabilidadAtaque("RocaAfilada",Tipo.obtenerUnTipo("Roca"),100,5);
        golem.añadirHabilidad(rocaAfilada);
        Habilidad punioTrueno = new HabilidadAtaque("PuñoTrueno",Tipo.obtenerUnTipo("Electrico"),75,15);
        ...
        100, 115, 90, 170);
        Habilidad ascensoDraco = new HabilidadAtaque("AscensoDraco",Tipo.obtenerUnTipo("Dragon"),120,5);
        rayquaza.añadirHabilidad(ascensoDraco);
        Habilidad poderPasado = new HabilidadAtaque("PoderPasado",Tipo.obtenerUnTipo("Roca"),60,5);
        rayquaza.añadirHabilidad(poderPasado);
        Habilidad triturar = new HabilidadAtaque("Triturar",Tipo.obtenerUnTipo("Normal"),80,15);
        ...
        100, 62, 152, 90);
        Habilidad hidrobomba = new HabilidadAtaque("Hidrobomba",Tipo.obtenerUnTipo("Agua"),110,5);
        ...
        Habilidad picadura = new HabilidadAtaque("Picadura",Tipo.obtenerUnTipo("Bicho"),70,20);
        araquanid.añadirHabilidad(picadura);
        Habilidad ventisca = new HabilidadAtaque("Ventisca",Tipo.obtenerUnTipo("Hielo"),110,5);
        ...
        100, 5, 60, 6);
                Habilidad placaje = new HabilidadAtaque("Placaje",Tipo.obtenerUnTipo("Normal"),40,35);
        bidoof.añadirHabilidad(placaje);
        Habilidad mordisco = new HabilidadAtaque("Mordisco",Tipo.obtenerUnTipo("Normal"),60,25);
        ...
        Habilidad ultimoRecurso = new HabilidadAtaque("UltimoRecurso",Tipo.obtenerUnTipo("Normal"),999,1);
